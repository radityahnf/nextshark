...
export default function TopStoriesSide() {
  ...
  return (
    <>
      <div className="overflow-y-auto max-h-[1000px] mt-10">
            ...
            <Link href={article.url}>
              <div className="flex flex-row items-center mb-4">
                <div className="mr-4 relative w-40 max-w-40 h-40 max-h-40 min-w-40">
                  <Image
                    alt={
                      article.description || "Image description not available"
                    }
      ...
      <div>
        {visibleCount < news!.articles.length && (
          <button
            ...
            className="px-4 py-6 mt-4 w-full bg-white text-black/60 border-2 rounded-md hover:bg-black hover:text-white "
          >
            <p className="font-semibold ">See More Top Stories</p>
          </button>
        )}
      </div>
    </>
